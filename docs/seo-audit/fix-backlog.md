...
| C-7 | HIGH | Claims (verify) | **False-certification risk:** "GDPR, HIPAA, PCI-DSS, SOC 2 certified solutions" — confirm CIM actually holds these certs; if not, reframe to "-aligned practices" | `mobile-app-development/WhyChooseUs.tsx:24` | Awaiting owner confirmation | 2 | ⏳ |
