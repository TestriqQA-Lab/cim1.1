    ...
    const solutions = [
        {
            ...
            description: "Drive online sales with dynamic product ads, abandoned cart retargeting, and catalog campaigns.",
            features: [
        ...
        },
        {
            icon: Building2,
            title: "B2B Companies",
            description: "Generate qualified leads for B2B services with professional targeting and lead generation forms.",
            features: [
                "Lead gen forms",
        ...
        },
        {
            icon: Home,
            title: "Real Estate",
            description: "Showcase properties to qualified buyers with location-based targeting and virtual tour ads.",
            features: [
                "Location targeting",
                "Property listings",
                "Virtual tour ads",
        ...
        },
        {
            ...
            description: "Enroll students with targeted campaigns promoting online courses, webinars, and educational content.",
            features: [
                "Course promotion",
        ...
        },
        {
            ...
            description: "Drive foot traffic and online orders with local awareness campaigns and menu promotions.",
            features: [
                "Local awareness",
                "Menu highlights",
                "Order driving",
        ...
        },
        {
            ...
            description: "Build authority and generate leads for consulting, legal, medical, and financial services.",
            features: [
                "Authority building",
                "Service promotion",
                "Appointment booking",
