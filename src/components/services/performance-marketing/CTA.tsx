...
import { Target, ArrowRight, Phone, Sparkles } from "lucide-react";
        ...
        <section className="py-16 md:py-24 relative overflow-hidden transition-colors duration-300" style={{ backgroundColor: "var(--background)", color: "var(--foreground)" }}>
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div
                    ...
                    style={{ backgroundColor: "color-mix(in srgb, var(--brand-orange) 10%, transparent)" }}
                />
                <div
                    className="absolute bottom-0 right-1/4 w-96 h-96 rounded-full blur-3xl animate-pulse"
                    style={{ backgroundColor: "color-mix(in srgb, var(--brand-yellow) 10%, transparent)", animationDelay: "1s" }}
                />
            </div>
            ...
            <div className="mx-auto px-6 md:px-12 xl:px-20 max-w-5xl relative z-10">
                <div
                    ...
                    style={{
                        ...
                        borderColor: "color-mix(in srgb, var(--brand-orange) 30%, var(--border-color))",
                    }}
                >
                    {/* Decorative corners */}
                    <div className="absolute top-0 left-0 w-20 h-20 border-t-2 border-l-2 rounded-tl-3xl" style={{ borderColor: "var(--brand-orange)" }} />
                    <div className="absolute bottom-0 right-0 w-20 h-20 border-b-2 border-r-2 rounded-br-3xl" style={{ borderColor: "var(--brand-orange)" }} />
