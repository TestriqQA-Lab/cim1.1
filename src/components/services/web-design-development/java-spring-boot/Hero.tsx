...
import { ArrowRight, Coffee, ChevronRight, CheckCircle2, Zap } from "lucide-react";
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    backgroundImage: `
                        radial-gradient(circle at 15% 50%, rgba(109, 179, 63, 0.1), transparent 25%),
                        radial-gradient(circle at 85% 30%, rgba(248, 152, 32, 0.08), transparent 25%)
                    `,
                }}
            >
                {/* Grid Pattern */}
                <div
                    ...
                    style={{
                        backgroundImage: `linear-gradient(#6DB33F 1px, transparent 1px), linear-gradient(90deg, #6DB33F 1px, transparent 1px)`,
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="space-y-8 text-center lg:text-left">
                        ...
                        <div
                            ...
                            style={{
                                backgroundColor: "rgba(248, 152, 32, 0.1)",
                        ...
                        <div className="flex flex-wrap justify-center lg:justify-start gap-3 animate-slideUp delay-200">
                            {[
                                ...
                                >
                                    <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: "#F89820" }} />
                        ...
                        <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 animate-slideUp delay-300">
                            <Link
                                ...
                                style={{
                                    background: "linear-gradient(135deg, #6DB33F, #5A9A32)",
                                    boxShadow: "0 4px 20px rgba(109, 179, 63, 0.25)",
                                }}
                            >
                                Start Your Project
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 sm:gap-8 pt-6 border-t animate-slideUp delay-400" style={{ borderColor: "var(--border-color)" }}>
                            ...
                            <div className="w-px h-10 bg-border hidden sm:block" style={{ backgroundColor: "var(--border-color)" }} />
                            <div className="text-center lg:text-left">
                                <h4 className="text-3xl font-bold" style={{ color: "#6DB33F" }}>99.9%</h4>
                        ...
                        <div className="relative flex items-center justify-center">
                            <div
                                ...
                                style={{
                                    ...
                                    background: "linear-gradient(135deg, rgba(109, 179, 63, 0.05), var(--card-bg))",
                                }}
                            >
                                {/* Spring Logo - Center */}
                                <div className="w-48 h-48 md:w-64 md:h-64 relative">
                                    <Image
                                        src="/images/techstack_logos/spring-logo.svg"
                                        alt="Spring Boot"
                                        fill
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div
                                        ...
                                        style={{ background: "linear-gradient(135deg, #6DB33F, #5A9A32)" }}
                                    >
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div
                                        className="w-12 h-12 rounded-xl flex items-center justify-center"
                                        style={{ background: "linear-gradient(135deg, #F89820, #E88B1C)" }}
                                    >
                            ...
                            <div className="flex flex-wrap gap-2">
                                {["Java 21", "Spring Boot 3", "Spring Cloud", "Hibernate", "Kafka", "Docker"].map((tech, idx) => (
                                    <span
                                        ...
                                        style={{
                                            backgroundColor: "rgba(109, 179, 63, 0.05)",
                                            borderColor: "rgba(109, 179, 63, 0.15)",
                                            color: "var(--foreground)",
                                        }}
                                    >
                                        {tech}
