                ...
                >
                    ...
                    <div className="relative z-10 text-center max-w-3xl mx-auto">
                        ...
                        >
                            ...
                            <span className="text-sm font-semibold font-mono" style={{ color: "var(--accent-cyan-text)" }}>
                                npx create-next-app
                            </span>
                        </div>
