...
export default function UseCases() {
    ...
    const industries = [
        ...
        },
        {
            ...
            bgColor: "#d97706",
            stats: "Client Portals",
            tags: ["Professional", "Compliant", "Secure"],
        },
        {
            icon: Layers,
            ...
            bgColor: "#16a34a",
            stats: "500+ Vendors",
            tags: ["Two-Sided", "Payments", "Matching"],
        },
        {
            icon: Users,
            ...
            bgColor: "#4f46e5",
            stats: "50k Members",
            tags: ["Real-time", "Social", "Engagement"],
        },
        {
            icon: Cog,
            ...
            bgColor: "#ea580c",
            stats: "15 Tools",
            tags: ["Automation", "Efficiency", "Integration"],
        },
    ];
