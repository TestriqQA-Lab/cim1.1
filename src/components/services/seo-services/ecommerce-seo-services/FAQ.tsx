...
export default function FAQ() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: <>Ecommerce SEO cost for business 2026 varies by store size and complexity:<br /><br />• Small Online Stores (100-500 products): $1,500-$3,000/month<br />• Mid-Size Ecommerce (500-5,000 products): $3,000-$7,000/month<br />• Enterprise Brands (5,000+ products): $7,000-$15,000/month<br />• Custom/Headless: $10,000-$25,000/month<br /><br />Pricing includes <Link href="/services/seo-services/technical-seo-services" className="hover:underline" style={{ color: commerceBlue }}>technical SEO for ecommerce websites</Link>, on-page optimization, content creation, <Link href="/services/seo-services/link-building" className="hover:underline" style={{ color: commerceBlue }}>link building</Link>, and monthly reporting. Most clients see 3-5x ROI within 6-9 months. One-time ecommerce SEO audit and strategy services range from $2,500-$8,000.</>
        },
        {
        ...
        },
        {
            ...
            answer: <>Ecommerce SEO timeline:<br /><br />• 30-60 days: Technical fixes implemented, indexation improves, low-competition keywords begin ranking<br />• 60-90 days: Category pages rank for mid-competition keywords, organic traffic increases 25-50%<br />• 90-120 days: Product pages gain traction, featured snippets appear, traffic up 50-100%<br />• 6 months: Significant rankings for competitive keywords, 150-300% traffic increase, measurable revenue growth<br />• 12 months: Market dominance, 300-500% traffic increase, sustainable revenue from organic search<br /><br />Results vary based on competition, starting authority, and implementation speed. Ecommerce SEO for international markets may take longer due to geo-targeting complexity.</>
        },
        {
