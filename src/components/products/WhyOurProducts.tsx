        ...
        <section className="py-24 relative overflow-hidden border-t" style={{ backgroundColor: "var(--background)", borderColor: "#555555" }}>
            <div className="mx-auto px-6 md:px-12 xl:px-20 relative z-10">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 border" style={{ backgroundColor: "var(--card-bg)", borderColor: `${purple}40` }}>
                            <Sparkles className="w-4 h-4" style={{ color: purple }} />
                            <span className="text-sm font-medium" style={{ color: "var(--brand-purple-text)" }}>Why Choose Us</span>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="p-6 rounded-2xl border" style={{ borderColor: "var(--border-color)", backgroundColor: "var(--card-bg)" }}>
                                <h3 className="text-3xl font-bold mb-2" style={{ color: purple }}>300+</h3>
                                <p className="text-sm" style={{ color: "var(--secondary-text)" }}>Client Projects Delivered</p>
                            </div>
                            <div className="p-6 rounded-2xl border" style={{ borderColor: "var(--border-color)", backgroundColor: "var(--card-bg)" }}>
                                <h3 className="text-3xl font-bold mb-2" style={{ color: purple }}>99.99%</h3>
