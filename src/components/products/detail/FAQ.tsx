            ...
            <div className="mx-auto px-6 md:px-12 xl:px-20 relative z-10">
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    <div className="lg:sticky lg:top-32">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 border" style={{ backgroundColor: `${color}15`, borderColor: `${color}40` }}>
                            <HelpCircle className="w-4 h-4" style={{ color }} />
                            <span className="text-sm font-medium" style={{ color }}>FAQ</span>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="p-6 rounded-2xl border" style={{ borderColor: "var(--border-color)", backgroundColor: "var(--background)" }}>
                                <h4 className="text-3xl font-bold mb-2" style={{ color }}>{product.faqs.length}</h4>
                                <p className="text-sm" style={{ color: "var(--secondary-text)" }}>Common Questions</p>
                            </div>
                            <div className="p-6 rounded-2xl border" style={{ borderColor: "var(--border-color)", backgroundColor: "var(--background)" }}>
                                <h4 className="text-3xl font-bold mb-2" style={{ color }}>24/7</h4>
