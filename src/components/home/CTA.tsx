            ...
            <div className="mx-auto max-w-6xl px-6 md:px-12 xl:px-20">
                <div style={{ padding: 48, borderRadius: 16, background: "linear-gradient(90deg, var(--brand-blue), var(--brand-cyan))", color: "#fff", textAlign: "center", boxShadow: "0 15px 40px rgba(0, 138, 193, 0.3)" }}>
                    ...
                    <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
                        <Link href="/contact" style={{ padding: "14px 28px", borderRadius: 999, background: "#fff", color: "var(--brand-blue)", fontWeight: 800, transition: "all 0.3s" }} className="hover:bg-gray-100">Book a Call <ChevronRight className="w-4 h-4 inline-block ml-2" /></Link>
