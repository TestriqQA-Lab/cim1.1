    ...
    const caseStudies = [
        {
            ...
            description: "Comprehensive funnel redesign, targeted content and a paid media program delivered a significant increase in qualified leads and a meaningful reduction in CAC within 3 months.",
            metric: "Growth",
            metricLabel: "Leads",
