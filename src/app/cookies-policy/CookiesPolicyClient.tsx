...
const CookiesPolicyClient: React.FC = () => {
            ...
            content: [
                {
                    subtitle: "",
                    text:
                        "Our site is not intended for children under 18. We do not knowingly collect personal details from minors and our cookie usage is designed accordingly.",
                },
            ],
        },
