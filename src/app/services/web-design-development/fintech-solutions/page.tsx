...
export default function FinTechSolutionsPage() {
    const fintechSchema = generateGraphSchema(
        ...
        generateHowToSchema({
            ...
            description: "A security-first 6-step methodology for building financial platforms that have processed $10B+ with 99.99% uptime and <100ms transaction speed.",
            steps: [
