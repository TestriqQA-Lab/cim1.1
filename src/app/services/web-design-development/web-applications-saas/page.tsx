...
const FAQ = dynamic(() => import('@/components/services/web-design-development/web-applications-saas/FAQ'), {
    loading: () => <div className="py-20" />,
});
...
export default function WebApplicationsSaaSPage() {
    ...
    const combinedSchema = {
        ...
        "@graph": [
            ...
            {
                "@type": "Service",
                "@id": "https://www.cinuteinfomedia.com/services/web-design-development/web-applications-saas#service",
            ...
            {
                "@type": "WebPage",
                "@id": "https://www.cinuteinfomedia.com/services/web-design-development/web-applications-saas#webpage",
                "url": "https://www.cinuteinfomedia.com/services/web-design-development/web-applications-saas",
