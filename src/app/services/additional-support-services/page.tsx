...
export default function AdditionalSupportServicesPage() {
    const supportSchema = generateGraphSchema(
...

        {
            ...
            "description": "Ongoing Support. Lasting Success. Optimize your operations with premium Business Support Services designed for global scalability. From technical maintenance to administrative efficiency, we provide the backbone your business needs to thrive. 500+ happy clients, 15+ years experience, 50+ dedicated support staff, rigorously tested technical maintenance, 300% operational efficiency improvements. 20-30% reduction in overhead costs. Seamless integration with client tools like Jira and Slack. Serving global markets: US, EU, India, and APAC with 24/7 coverage.",
