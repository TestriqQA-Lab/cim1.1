...
export const metadata: Metadata = {
    ...
    description:
        "Leading hybrid mobile app development company. Build high-performance, single codebase apps for iOS & Android with Ionic & Capacitor. measurable CTR boost!",
    keywords: [
    ...
    openGraph: {
        title: "Hybrid App Development Services | Top Cross-Platform Agency 2026 \uD83D\uDE80",
        description: "Leading hybrid mobile app development company. Build high-performance, single codebase apps for iOS & Android with Ionic & Capacitor. measurable CTR boost!",
