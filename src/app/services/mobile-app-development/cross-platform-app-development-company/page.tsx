...
export const metadata: Metadata = {
    ...
    description:
        "🚀 Award-winning Cross-Platform App Development Services. We build high-performance, native-like iOS & Android apps with a single codebase. faster delivery. lower costs. Start your project today! 📱",
    keywords: [
