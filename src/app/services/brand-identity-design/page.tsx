...
export const metadata = getPageMetadata({
    ...
    description: 'Transform your business with world-class brand identity design services. We craft custom logos, visual systems, and strategies for startups and enterprises. 500+ successful brand launches, strong average ROI, strong client retention. More than just a logo — we build scalable brand ecosystems using 2026 EEAT principles.',
