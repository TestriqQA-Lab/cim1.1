...
import Hero from "@/components/services/seo-services/content-seo/Hero";
import ServiceOverview from "@/components/services/seo-services/content-seo/ServiceOverview";
import SolutionTypes from "@/components/services/seo-services/content-seo/SolutionTypes";
import TechStack from "@/components/services/seo-services/content-seo/TechStack";
import Process from "@/components/services/seo-services/content-seo/Process";
import WhyChooseUs from "@/components/services/seo-services/content-seo/WhyChooseUs";
import CTA from "@/components/services/seo-services/content-seo/CTA";

export const metadata: Metadata = {
    title: "SEO Content Services | Content SEO Agency & Writing 2026 | +200% ROI",
    description:
        "Leading SEO content agency providing expert SEO content writing services for small business, SaaS, & E-commerce. Scale traffic with 2026 EEAT-ready content!",
    keywords: [
        "content SEO",
