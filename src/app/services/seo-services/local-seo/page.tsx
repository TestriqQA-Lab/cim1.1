...
import Hero from "@/components/services/seo-services/local-seo/Hero";
import ServiceOverview from "@/components/services/seo-services/local-seo/ServiceOverview";
import SolutionTypes from "@/components/services/seo-services/local-seo/SolutionTypes";
import TechStack from "@/components/services/seo-services/local-seo/TechStack";
import Process from "@/components/services/seo-services/local-seo/Process";
import WhyChooseUs from "@/components/services/seo-services/local-seo/WhyChooseUs";
import FAQ from "@/components/services/seo-services/local-seo/FAQ";
import CTA from "@/components/services/seo-services/local-seo/CTA";

export const metadata: Metadata = {
    title: "Local SEO Services , Google Maps Marketing Agency 2026",
    description:
        "Get found locally! Expert Local SEO services drive 3x more calls & dominate Google Maps. GMB optimization, citations & reviews. Free audit today!",
    keywords: [
        "local SEO services",
